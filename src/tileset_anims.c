...
{
    u16 i = timer % 4;
    AppendTilesetAnimToBuffer(gTilesetAnims_General_Flower[i], (u16 *)(BG_VRAM + TILE_OFFSET_4BPP(504)), 0x80);
}
...
{
    u16 i = timer % 2; 
    AppendTilesetAnimToBuffer(gTilesetAnims_General_PondWaterEdge[i], (u16 *)(BG_VRAM + TILE_OFFSET_4BPP(475)), 0x20);
}

static void QueueAnimTiles_General_PondWaterSide(u16 timer)
{
    u16 i = timer % 8; 
    AppendTilesetAnimToBuffer(gTilesetAnims_General_PondWaterSide[i], (u16 *)(BG_VRAM + TILE_OFFSET_4BPP(476)), 0x20);
}

static void QueueAnimTiles_General_PondWaterTop(u16 timer)
{
    u16 i = timer % 8; 
    AppendTilesetAnimToBuffer(gTilesetAnims_General_PondWaterTop[i], (u16 *)(BG_VRAM + TILE_OFFSET_4BPP(477)), 0x20);
}
