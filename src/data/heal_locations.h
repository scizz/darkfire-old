static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_LAVERIA_CITY - 1] = {MAP_GROUP(LAVERIA_CITY), MAP_NUM(LAVERIA_CITY), 25, 41},
    [HEAL_LOCATION_HIGHWIND_VILLAGE - 1] = {MAP_GROUP(HIGHWIND_VILLAGE), MAP_NUM(HIGHWIND_VILLAGE), 25, 31},
};
